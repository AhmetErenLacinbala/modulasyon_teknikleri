...
export default function Comp34(props) {
    return (
        <div style={{ display: "flex" }}>
            <img style={{ width: "23%", position: "fixed", bottom: "25px", right: "25px" }} src="https://raw.githubusercontent.com/AhmetErenLacinbala/modulasyon_teknikleri/master/src/comps/comp34/pcm.jpg" alt="" />
            <div style={{ flexDirection: "column", backgroundColor: "rgba(11,11,11,0.5)" }} className="comp compFullSize compContent">
                <div className='compContent' style={{ width: "75%", }}>
...
yeniden yapılandırma filtresi olarak adlandırılır.</p>
 <p style={{ marginLeft: "50px", lineHeight:"60px" }} className=' fontS32 fontW300 openSansFont'> Vericide yapılan işlem, orijinal analog mesaj sinyalini üretmek için alıcıda
